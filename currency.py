...
def format_output(date, from_currency, to_currency, rate, amount):
    """
    Function that will give the outcome of formatting information about FX conversion rates in string.
    ...
    *
    ...
    return f"""
    The conversion rate on {date} 
    from {from_currency} to {to_currency} was {rounded_rate} .
    So {amount} in {from_currency}  correspond to {round(convert_currencies, 4)} in {to_currency}.
